...
const meta = reactive(
	{
		...
		dataUrl: route("leads.getSelectedRetainedLeads"),
		data: {
			count: null,
		},
		date_used: {
...
const sumOfVisibleRetainedLeads = ref(0);
...
const calculateTotal = (from, to) => {
	...
	sumOfVisibleRetainedLeads.value = sum ?? "__";
};
			...
			>
				<div class="flex items-center">
					<div>
						...
						>
							Retained leads: {{ sumOfVisibleRetainedLeads }}
						</h5>
					</div>
				</div>
