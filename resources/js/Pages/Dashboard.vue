...
const has_elevated_permission =
   usePage().props?.auth?.user?.employee?.has_elevated_permission ?? null;
      ...
      <div class="py-12">
         <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <section
               ref="toolbar"
               :class="{
                  'fixed top-2 right-0 md:right-5 p-2 md:p-4 bg-gray-200 z-[1000]':
                     isFixed,
               }"
               class="mb-4 rounded"
            >
                  ...
                  <div class="flex items-center justify-between">
                     <div>
                        <div class="w-full md:block md:w-auto">
                           <ul
                              class="font-medium flex flex-col p-4 md:p-0 mt-4 border-2 border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white"
                           >
                              <li>
                                 <a
                                    href="#leads"
                                    class="block py-2 px-3 text-gray-900 hover:text-blue-700"
                                    aria-current="page"
                                    >Leads</a
                                 >
                              </li>
                        ...
                        >
                           ...
                           >
                              <span v-if="(button?.name ?? '') === 'Custom'">
                                 {{ button.name }}
                                 <span v-if="leadChartStore.getRangeDateString">
            ...
            <div class="flex flex-col gap-10 relative">
               ...
               <section v-if="has_elevated_permission !== null" id="finances">
                  <Financial_Charts />
               </section>
               <section id="cases">
                  <Cases_Charts />
