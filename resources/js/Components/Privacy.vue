...
<template>
	<section class="my-8">
		...
		<p class="mb-4">Last updated: March 26, 2024</p>
		<p class="mb-4">
		...
		<ul class="list-disc pl-6 mb-4">
			...
			<li>
				...
				"Us" or "Our" in this Agreement) refers to E-Justice Project, APC, 125
				12th Street Ste 100 BALI Oakland, CA 94607.
			</li>
			<li>
			...
			<li>
				<strong>Website</strong> refers to E-Justice Project, accessible from
				<a
					href="https://hq.ejpapc.com/"
					rel="external nofollow noopener"
					target="_blank"
					class="text-blue-500"
					>https://hq.ejpapc.com/</a
				>
			</li>
			<li>
		...
		<ul class="list-disc pl-6 mb-4">
			<li>
				<p class="mb-4"><strong>Necessary / Essential Cookies</strong></p>
			...
			<li>
				<p class="mb-4"><strong>Functionality Cookies</strong></p>
				<p class="mb-4">Type: Persistent Cookies</p>
				<p class="mb-4">Administered by: Us</p>
				<p class="mb-4">
		...
		<ul class="list-disc pl-6 mb-4">
			<li>
				...
				<a
					...
					rel="external nofollow noopener"
					target="_blank"
					>https://www.ejusticeproject.com/</a
				>
			</li>
		</ul>
	</section>
