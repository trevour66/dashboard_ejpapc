<script setup>
import ToolTipWapper from "./ToolTipWapper.vue";
defineProps({
   tooltip_string: {
      type: String,
      required: false,
...
<template>
   <ToolTipWapper :tooltip_string="tooltip_string">
      <template #icon>
         <svg
            class="w-4 h-4"
            viewBox="0 0 16 16"
         ...
         >
            ...
            <g id="SVGRepo_iconCarrier">
               ...
               <path
                  class="error"
                  color="#000000"
                  d="M12.5 9A3.5 3.5 0 0 0 9 12.5a3.5 3.5 0 0 0 3.5 3.5 3.5 3.5 0 0 0 3.5-3.5A3.5 3.5 0 0 0 12.5 9zm-.5 1h1v1.168c0 .348-.016.667-.047.957-.03.29-.069.581-.115.875h-.666a12.898 12.898 0 0 1-.125-.875 9.146 9.146 0 0 1-.047-.957zm.5 4a.5.5 0 0 1 .5.5.5.5 0 0 1-.5.5.5.5 0 0 1-.5-.5.5.5 0 0 1 .5-.5z"
                  fill="#f22c42"
                  overflow="visible"
                  style="marker: none"
               ></path>
